...
public class MakeMyTripCalenderTest {
	...
	public void testDAtePicker() throws Exception {
		...
		WebElement selectDate = driver.findElement(
				By.xpath("(//input[@aria-controls='datetimepicker_dateview datetimepicker_timeview']/..//span)[2]"));

		selectDate.click();

		// button to move next in calendar

		WebElement nextLink = driver.findElement(By.xpath("//div[@class=\"k-calendar k-calendar-md\"]/*/*[3]/*"));
